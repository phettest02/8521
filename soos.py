...
**LINE: http://line.me/R/ti/p/~muhmursalind**
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Created By:\n http://line.me/R/ti/p/~muhmursalind",
    "lang":"JP",
    "comment":"Created By:\n http://line.me/R/ti/p/~muhmursalind",
    "commentOn":False,
    "commentBlack":{},
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "Created By : ༺Ƥɾøтøтуρє༻ʳᵉᵏᵗ")
...
#-----------------------------------------------
            ...
            elif msg.text in ["All join","all join","Reina","reina","woi masuk"]:
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["Bot1 @bye","sagiri bye","bye"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
